...
def get_reference_feats(img_meta,
    ...
    return point_features.squeeze().t(), points.new_tensor((grid + 1)/2)


@FUSION_LAYERS.register_module()
class DeformPointFusionV2(BaseModule):
    ...
    def __init__(self,
                 ...
                 padding_mode='zeros',
                 lateral_conv=True):
        super(DeformPointFusionV2, self).__init__(init_cfg=init_cfg)
    ...
    def sample_single(self, img_feats, pts, pts_feats, img_meta, level_num):
        ...
        img_pts = self.deform_layers[level_num](ref_feats, ref_points, flatten_img_feat, level_spatial_shapes, level_start_index).squeeze(0)
